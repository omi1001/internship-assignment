    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">
          Fill the form to download the program brochure.
        </p>
      </div>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <button className="w-full bg-iim-gold text-white py-5 rounded-xl font-bold text-lg shadow-xl transition-all duration-300 hover:bg-iim-navy hover:scale-[1.02] active:scale-95 cursor-pointer">
          Apply Now
        </button>
      </form>
    </motion.div>
